...
public class CalendarAdapter extends BaseAdapter {
	...
	public String getDate(int position) {
		String day = dayNumber[position].substring(0,
				dayNumber[position].indexOf("."));
		if (Integer.valueOf(day) < 10)
			day = "0" + day;
		String tempMonth = "1";
		String tempYear = showYear;
		// 本月
		if (position < daysOfMonth + dayOfWeek && position >= dayOfWeek) {
			if (Integer.valueOf(showMonth) < 10)
				tempMonth = "0" + showMonth;
			else
				tempMonth = showMonth;
		}
		// 前月
			...
			int tempMonth2 = Integer.valueOf(showMonth) - 1;
			if (tempMonth2 == 0)
			{
				tempYear = (Integer.valueOf(tempYear) - 1) + "";
				tempMonth2=12;
			}
			

			if (tempMonth2 < 10)
				tempMonth = "0" + tempMonth2;
			else
				tempMonth = tempMonth2 + "";
		}
		// 下月
		else {
			int tempMonth3 = Integer.valueOf(showMonth) + 1;
			if (tempMonth3 == 13)
			{
				tempYear = (Integer.valueOf(tempYear) + 1) + "";
				tempMonth3=1;
			...
			if (tempMonth3 < 10)
				tempMonth = "0" + tempMonth3;
			else
				tempMonth = tempMonth3 + "";

		}
		return tempYear + "-" + tempMonth + "-" + day;
